...
SAMTOOLS_URL=http://sourceforge.net/projects/samtools/files/samtools/1.0/samtools-bcftools-htslib-1.0_x64-linux.tar.bz2/download
...
# enable universe for python-matplotlib; only needed in ubuntu live
